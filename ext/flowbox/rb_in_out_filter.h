...
#ifndef FLOWBOXRUBY_EXT_RB_IN_OUT_FILTER_H__
#define FLOWBOXRUBY_EXT_RB_IN_OUT_FILTER_H__

#include "ruby.h"
#include <flowbox/in_out_filter.h>

#define RB_IN_OUT_FILTER_UNWRAP InOutFilter* iof; Data_Get_Struct(self, InOutFilter, iof);
...
#endif  // FLOWBOXRUBY_EXT_RB_IN_OUT_FILTER_H__
